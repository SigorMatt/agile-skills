...
You are running the **answer-questions** skill of the agile-skills pipeline, as the **architect**.
...
- Human interaction: **direct**
- Hard gates: `answer-is-propagated`, `answered-from-the-record`, `escalation-is-justified`, `propagated-claims-carry-their-obligation`, `engagement-state-is-left-to-the-ending`, `cross-answer-consistency`, `workspace-valid`, `item-resumed-correctly`, `a-deferral-is-not-an-answer`
...
`scripts/journal-entry --template --skill answer-questions` prints the shape, and it is the shortest way
