...
- Human interaction: **direct**
- Hard gates: `workspace-valid`, `every-criterion-is-addressed`, `project-commands-resolved`, `decisions-recorded`, `documents-at-risk-are-enumerated`, `cross-answer-consistency`, `claims-are-sourced`
- On success: `planned`
...
`scripts/journal-entry --template --skill plan` prints the shape, and it is the shortest way
