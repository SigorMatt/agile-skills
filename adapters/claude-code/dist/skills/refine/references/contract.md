...
| `qa-recorded-verbatim` | every type this skill is dispatched on | hard | refinement-qa.md contains every question asked and every answer received, each tagged human or assumed, with nothing paraphrased into agreement, and every assumed answer taken under a standing delegation carrying its Under delegation line - the answer ID that granted the licence and the category it is taken to cover. | stay |
