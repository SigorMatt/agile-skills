...
| `scripts/engagement-state <EP-ID>` | yes | whether an engagement is still running or is over - the one judgement this skill is not allowed to make for itself |
...
- [ ] Every epic still at open was asked scripts/engagement-state, and none of them is at-rest and undispatched.
