...
- Hard gates: `tests-pass`, `lint-clean`, `workspace-valid`, `every-criterion-has-a-test`, `commits-reference-the-item`, `cross-answer-consistency`, `claims-are-sourced`, `document-writes-are-declared`
