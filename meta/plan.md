...
- [ ] **META-002** — Verify current Claude Code skill format against official docs; record findings +
...
- [ ] **META-020** — `methodology/pipeline.yaml` (status graph, status→skill map, dispatch rules).
